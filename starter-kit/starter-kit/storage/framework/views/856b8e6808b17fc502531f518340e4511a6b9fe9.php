        ...
        <div id="messages" class="col s12 pb-0">
          <div class="collection border-none mb-0">
            ...
            <ul class="collection right-sidebar-chat p-0 mb-0">
              ...
              <li class="collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar pl-5 pb-0"
                data-target="slide-out-chat">
                <span class="avatar-status avatar-online avatar-50"><img src="<?php echo e(asset('images/avatar/avatar-1.png')); ?>"
                    alt="avatar" />
                  <i></i>
                </span>
                <div class="user-content">
              ...
              <li class="collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar pl-5 pb-0"
                data-target="slide-out-chat">
                <span class="avatar-status avatar-off avatar-50"><img src="<?php echo e(asset('images/avatar/avatar-2.png')); ?>"
                    alt="avatar" />
                  <i></i>
                </span>
                <div class="user-content">
              ...
              <li class="collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar pl-5 pb-0"
                data-target="slide-out-chat">
                <span class="avatar-status avatar-online avatar-50"><img src="<?php echo e(asset('images/avatar/avatar-3.png')); ?>"
                    alt="avatar" />
                  <i></i>
                </span>
                <div class="user-content">
              ...
              <li class="collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar pl-5 pb-0"
                data-target="slide-out-chat">
                <span class="avatar-status avatar-online avatar-50"><img src="<?php echo e(asset('images/avatar/avatar-4.png')); ?>"
                    alt="avatar" />
                  <i></i>
                </span>
                <div class="user-content">
              ...
              <li class="collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar pl-5 pb-0"
                data-target="slide-out-chat">
                <span class="avatar-status avatar-off avatar-50"><img src="<?php echo e(asset('images/avatar/avatar-5.png')); ?>"
                    alt="avatar" />
                  <i></i>
                </span>
                <div class="user-content">
              ...
              <li class="collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar pl-5 pb-0"
                data-target="slide-out-chat">
                <span class="avatar-status avatar-online avatar-50"><img src="<?php echo e(asset('images/avatar/avatar-6.png')); ?>"
                    alt="avatar" />
                  <i></i>
                </span>
                <div class="user-content">
              ...
              <li class="collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar pl-5 pb-0"
                data-target="slide-out-chat">
                <span class="avatar-status avatar-off avatar-50"><img src="<?php echo e(asset('images/avatar/avatar-7.png')); ?>"
                    alt="avatar" />
                  <i></i>
                </span>
                <div class="user-content">
              ...
              <li class="collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar pl-5 pb-0"
                data-target="slide-out-chat">
                <span class="avatar-status avatar-off avatar-50"><img src="<?php echo e(asset('images/avatar/avatar-8.png')); ?>"
                    alt="avatar" />
                  <i></i>
                </span>
                <div class="user-content">
              ...
              <li class="collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar pl-5 pb-0"
                data-target="slide-out-chat">
                <span class="avatar-status avatar-online avatar-50"><img src="<?php echo e(asset('images/avatar/avatar-9.png')); ?>"
                    alt="avatar" />
                  <i></i>
                </span>
                <div class="user-content">
              ...
              <li class="collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar pl-5 pb-0"
                data-target="slide-out-chat">
                <span class="avatar-status avatar-off avatar-50"><img src="<?php echo e(asset('images/avatar/avatar-10.png')); ?>"
                    alt="avatar" />
                  <i></i>
                </span>
                <div class="user-content">
              ...
              <li class="collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar pl-5 pb-0"
                data-target="slide-out-chat">
                <span class="avatar-status avatar-off avatar-50"><img src="<?php echo e(asset('images/avatar/avatar-11.png')); ?>"
                    alt="avatar" />
                  <i></i>
                </span>
                <div class="user-content">
              ...
              <li class="collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar pl-5 pb-0"
                data-target="slide-out-chat">
                <span class="avatar-status avatar-online avatar-50"><img src="<?php echo e(asset('images/avatar/avatar-12.png')); ?>"
                    alt="avatar" />
                  <i></i>
                </span>
                <div class="user-content">
...
<!-- END RIGHT SIDEBAR NAV --><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/materialize-admin/materialize-html-laravel-starter-kit-template/resources/views/pages/sidebar/right-sidebar.blade.php ENDPATH**/ ?>