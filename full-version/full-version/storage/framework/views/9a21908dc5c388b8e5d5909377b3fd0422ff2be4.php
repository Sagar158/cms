                      ...
                      <div class="sidebar-header">
                        <div class="row valign-wrapper">
                          <div class="col s2 media-image pr-0">
                            <img src="<?php echo e(asset('images/user/12.jpg')); ?>" alt="" class="circle z-depth-2 responsive-img">
                          </div>
                          <div class="col s10">
                        ...
                        <div class="chat-list">
                            ...
                            <div class="user-section">
                              <div class="row valign-wrapper">
                                <div class="col s2 media-image online pr-0">
                                  <img src="<?php echo e(asset('images/user/2.jpg')); ?>" alt=""
                          ...
                          <div class="chat-user animate fadeUp delay-2 active">
                            <div class="user-section">
                              <div class="row valign-wrapper">
                                <div class="col s2 media-image online pr-0">
                                  <img src="<?php echo e(asset('images/user/7.jpg')); ?>" alt=""
                                    class="circle z-depth-2 responsive-img">
                                </div>
                                <div class="col s10">
                            ...
                            <div class="user-section">
                              <div class="row valign-wrapper">
                                <div class="col s2 media-image away pr-0">
                                  <img src="<?php echo e(asset('images/user/10.jpg')); ?>" alt=""
                                    class="circle z-depth-2 responsive-img">
                                </div>
                                <div class="col s10">
                            ...
                            <div class="user-section">
                              <div class="row valign-wrapper">
                                <div class="col s2 media-image offline pr-0">
                                  <img src="<?php echo e(asset('images/user/4.jpg')); ?>" alt=""
                                    class="circle z-depth-2 responsive-img">
                                </div>
                                <div class="col s10">
                          ...
                          <div class="chat-user animate fadeUp delay-5">
                            <div class="user-section">
                              <div class="row valign-wrapper">
                                <div class="col s2 media-image pr-0">
                                  <img src="<?php echo e(asset('images/user/8.jpg')); ?>" alt=""
                                    class="circle z-depth-2 responsive-img">
                                </div>
                                <div class="col s10">
                          ...
                          <div class="chat-user animate fadeUp delay-5">
                            <div class="user-section">
                              <div class="row valign-wrapper">
                                <div class="col s2 media-image pr-0">
                                  <img src="<?php echo e(asset('images/user/1.jpg')); ?>" alt=""
                                    class="circle z-depth-2 responsive-img">
                                </div>
                                <div class="col s10">
                          ...
                          <div class="chat-user animate fadeUp delay-5">
                            <div class="user-section">
                              <div class="row valign-wrapper">
                                <div class="col s2 media-image away pr-0">
                                  <img src="<?php echo e(asset('images/user/9.jpg')); ?>" alt=""
                                    class="circle z-depth-2 responsive-img">
                                </div>
                                <div class="col s10">
                          ...
                          <div class="chat-user animate fadeUp delay-5">
                            <div class="user-section">
                              <div class="row valign-wrapper">
                                <div class="col s2 media-image offline pr-0">
                                  <img src="<?php echo e(asset('images/user/5.jpg')); ?>" alt=""
                                    class="circle z-depth-2 responsive-img">
                                </div>
                                <div class="col s10">
              ...
              <div class="chat-header">
                <div class="row valign-wrapper">
                  <div class="col media-image online pr-0">
                    <img src="<?php echo e(asset('images/user/7.jpg')); ?>" alt="" class="circle z-depth-2 responsive-img">
                  </div>
                  <div class="col">
                    <p class="m-0 blue-grey-text text-darken-4 font-weight-700">Alice Hawker</p>
                  ...
                  <div class="chats">
                    <div class="chat chat-right">
                      <div class="chat-avatar">
                        <a class="avatar">
                          <img src="<?php echo e(asset('images/user/12.jpg')); ?>" class="circle" alt="avatar" />
                        </a>
                      </div>
                      <div class="chat-body">
                        <div class="chat-text">
                    ...
                    <div class="chat">
                      <div class="chat-avatar">
                        <a class="avatar">
                          <img src="<?php echo e(asset('images/user/7.jpg')); ?>" class="circle" alt="avatar" />
                        </a>
                      </div>
                      <div class="chat-body">
                        <div class="chat-text">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/materialize-admin/materialize-html-laravel-template/resources/views/pages/app-chat.blade.php ENDPATH**/ ?>