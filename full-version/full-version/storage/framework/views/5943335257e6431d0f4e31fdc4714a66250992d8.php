<?php $__env->startSection('title','Dashboard Ecommerce'); ?>
         ...
         <div class="col s12 m4">
            <div class="card animate fadeLeft">
               <div class="card-content  center">
                  ...
                  <img src="<?php echo e(asset('images/cards/watch.png')); ?>" alt="" class="responsive-img" />
         ...
         <div class="col s12 m4">
            <div class="card animate fadeUp">
               <div class="card-content center">
                  ...
                  <img src="<?php echo e(asset('images/cards/headphones-2.png')); ?>" alt="" class="responsive-img" />
               </div>
         ...
         <div class="col s12 m4">
            <div class="card animate fadeRight">
               <div class="card-content center">
                  ...
                  <img src="<?php echo e(asset('images/cards/iphonec.png')); ?>" alt="" class="responsive-img" />
         ...
         <div class="row">
            <div class="col s12 m3">
               <div class="card gradient-shadow gradient-45deg-light-blue-cyan border-radius-3 animate fadeUp">
                  <div class="card-content center">
                     <img src="<?php echo e(asset('images/icon/apple-watch.png')); ?>"
            ...
            <div class="col s12 m3">
               <div class="card gradient-shadow gradient-45deg-red-pink border-radius-3 animate fadeUp">
                  <div class="card-content center">
                     <img src="<?php echo e(asset('images/icon/printer.png')); ?>"
            ...
            <div class="col s12 m3">
               <div class="card gradient-shadow gradient-45deg-amber-amber border-radius-3 animate fadeUp">
                  <div class="card-content center">
                     <img src="<?php echo e(asset('images/icon/laptop.png')); ?>"
                        class="width-40 border-round z-depth-5 responsive-img" alt="image" />
            ...
            <div class="col s12 m3">
               <div class="card gradient-shadow gradient-45deg-green-teal border-radius-3 animate fadeUp">
                  <div class="card-content center">
                     <img src="<?php echo e(asset('images/icon/bowling.png')); ?>"
                        class="width-40 border-round z-depth-5 responsive-img" alt="image" />
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/materialize-admin/materialize-html-laravel-template/resources/views//pages/dashboard-ecommerce.blade.php ENDPATH**/ ?>