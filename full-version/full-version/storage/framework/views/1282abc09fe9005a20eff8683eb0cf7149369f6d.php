  ...
  <nav
    ...
    <div class="nav-wrapper">
      ...
      <ul class="dropdown-content" id="profile-dropdown">
        <li>
          <a class="grey-text text-darken-1" href="<?php echo e(asset('user-profile-page')); ?>">
            <i class="material-icons">person_outline</i>
            Profile
          </a>
        </li>
        <li>
          <a class="grey-text text-darken-1" href="<?php echo e(asset('app-chat')); ?>">
            <i class="material-icons">chat_bubble_outline</i>
            Chat
          </a>
        </li>
        <li>
          <a class="grey-text text-darken-1" href="<?php echo e(asset('page-faq')); ?>">
        ...
        <li class="divider"></li>
        <li>
          <a class="grey-text text-darken-1" href="<?php echo e(asset('user-lock-screen')); ?>">
...
</ul><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/materialize-admin/materialize-html-laravel-template/resources/views/panels/navbar.blade.php ENDPATH**/ ?>