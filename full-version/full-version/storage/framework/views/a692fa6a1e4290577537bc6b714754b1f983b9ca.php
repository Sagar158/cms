<?php $__env->startSection('title','App ToDo'); ?>
...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/pages/app-todo.css')); ?>">
<?php $__env->stopSection(); ?>
      ...
      <form class="edit-todo-item mt-10 mb-10">
        ...
        <div class="input-field">
          <div class="display-flex">
            <div class="assignto display-flex">
              <div class="avatar">
                <img src="<?php echo e(asset('images/avatar/avatar-10.png')); ?>" class="responsive-img circle z-depth-2" width="50"
                  alt="">
              </div>
              <select>
        ...
        <div class="display-flex align-items-center mt-5">
          <div class="avatar mr-5">
            <img src="<?php echo e(asset('images/avatar/avatar-2.png')); ?>" width="40" class="circle responsive-img" alt="">
          </div>
...
<script src="<?php echo e(asset('js/scripts/app-todo.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/materialize-admin/materialize-html-laravel-template/resources/views/pages/app-todo.blade.php ENDPATH**/ ?>