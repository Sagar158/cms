         ...
         <div class="col s12 m12 l4">
            <div id="profile-card" class="card animate fadeRight">
               <div class="card-image waves-effect waves-block waves-light">
                  <img class="activator" src="<?php echo e(asset('images/gallery/3.png')); ?>" alt="user bg" />
               </div>
               <div class="card-content">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/materialize-admin/materialize-html-laravel-template/resources/views//pages/dashboard-analytics.blade.php ENDPATH**/ ?>